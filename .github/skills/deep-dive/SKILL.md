...
Run the trace autonomously using the `oh-my-copilot-cli:trace` skill's behavioral contract.
...
- Use `Agent(subagent_type="oh-my-copilot-cli:explore", model="haiku")` for brownfield codebase exploration (Phase 1)
