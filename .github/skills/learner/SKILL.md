...
- **User-level**: `${CLAUDE_CONFIG_DIR:-~/.claude}/skills/omcc-learned/<skill-name>.md` - Rare. Only for truly portable insights.
- **Project-level**: `.omcc/skills/<skill-name>.md` - Default. Version-controlled with repo.
