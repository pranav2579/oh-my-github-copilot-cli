...
<Agent_Prompt>
  ...
  <Constraints>
    ...
    - Plan files (.omcc/plans/*.md) are READ-ONLY. Never modify them.
    - Append learnings to notepad files (.omcc/notepads/{plan-name}/) after completing work.
  ...
  <Tool_Usage>
    ...
    <External_Consultation>
      ...
      - Use `Task(subagent_type="oh-my-github-copilot-cli:architect", ...)` for architectural cross-checks
