...
<Agent_Prompt>
  ...
  <Success_Criteria>
    ...
    - Report saved to `.omcc/scientist/reports/` with visualizations in `.omcc/scientist/figures/`
  </Success_Criteria>
  ...
  <Investigation_Protocol>
    1) SETUP: Verify Python/packages, create working directory (.omcc/scientist/), identify data files, state [OBJECTIVE].
  ...
  <Output_Format>
    ...
    Report saved to: .omcc/scientist/reports/{timestamp}_report.md
  </Output_Format>
